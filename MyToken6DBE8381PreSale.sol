...
import "./MyToken6DBE8381.sol";

contract MyToken6DBE8381PreSale {
    MyToken6DBE8381 public token;
    ...
    function MyToken6DBE8381PreSale(
        MyToken6DBE8381 _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken6DBE8381(_token);
